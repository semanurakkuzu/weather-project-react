          ...
          <div className="d-flex justify-content-around">
            <div className="card card-size">
              ...
              <div className="d-flex justify-content-center mt-1">
                <div>
                  <img src={wheatherData
                    && wheaterTypes[wheatherData.daily.weathercode[0]].icon} alt="" className="img-size" />
                </div>
              </div>
              <div>
              ...
              <div className="row my-3">
                ...
                <div className="col mt-1">
                  <div className="col">
                    <span>
                    { wheatherData &&
                      wheatherData.daily.windspeed_10m_max[0]
                    }
                    </span>
                    <span> km/h </span>
                  </div>
                ...
                <div className="col text-end me-3">
                  <span className="feels-like-text">
                    { wheatherData &&
                      wheatherData.daily.temperature_2m_max[0]
                    }
                    </span>
